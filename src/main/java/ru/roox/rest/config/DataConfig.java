...
@ComponentScan("ru.roox.rest")
@PropertySource("classpath:app.properties")
@EnableJpaRepositories("ru.roox.rest.dao")
public class DataConfig {
    ...
    private Properties getHibernateProperties() {
        ...
        properties.put(PROP_HIBERNATE_LAZY_LOAD, environment.getRequiredProperty(PROP_HIBERNATE_LAZY_LOAD));
